$(document).ready(function() {
    ...
    $.ajax({
        ...
        $.each(data, function(i, d) {
            ...
            $('#dataTable tbody').append('<tr><td>' + d.r_aula + '</td><td>' + d.r_reg_hash + '</td><td>' + d.u_nombre + '</td><td>' + estado + fecha.toLocaleString('en-GB') + '</td></tr>' );
        });
    });
    ...
    $('#informacion').click(function(){
        ...
        $.ajax({
            ...
            $.each(data, function(i, d) {
                ...
                $('#dataMaestro tbody').append('<tr><td>' + d.nombre + '</td><td>' + d.area + '</td><td>' + d.reg_hash + '</td><td>' + fecha.toLocaleString('en-GB') + '</td></tr>' );
            });
        }); 
    });
